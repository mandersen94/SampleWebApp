...
package com.google.enterprise.sdk.onebox.samples;

import com.google.enterprise.sdk.onebox.*;
import java.util.Iterator;

import org.markandersen.google.onebox.OneBoxProvider;
 ...
 */
public class NoAuthEmployeeDirectoryProvider extends OneBoxProvider {
			...
			String query, String[] matchGroups)
	{
		...
		res.setProviderText("NoAuthEmployeeDirectoryProvider: ACME Employee Directory");
