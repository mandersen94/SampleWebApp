...
public class SimpleSessionTrackingSessionListener implements
    ...
    private static final Logger logger = Logger.getLogger(SimpleSessionTrackingSessionListener.class);
    ...
    public void sessionCreated(HttpSessionEvent sessionEvent) {
        ...
        synchronized (SimpleSessionTrackingSessionListener.class) {
            numberOfSessions++;
            logger.info("SessionListener:sessionCreated(): numberOfSessions = "
